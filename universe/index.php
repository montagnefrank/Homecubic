...
trackvisitor("homecubic_univ_login");
...
<html lang="en" class="body-full-height">
    <head>        
        <title>Burton Universe - Administraci&oacute;n de Paquetes online</title>            
    ...
    <body>
        ...
        <div  class="login-container">
            <!--            <video class="fullscreen-bg__video" autoplay="" muted="" loop="">
                            <source type="video/mp4" src="assets/img/background/loop<?php echo rand(1, 8); ?>.mp4"/>
                        </video>-->
