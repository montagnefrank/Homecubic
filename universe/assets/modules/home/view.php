                ...
                <div class="owl-carousel" id="owl-example">
                    <div>                                    
                        ...
                        <div class="widget-int"><?php
                            $visit_select = "SELECT count(tracking_page_name) FROM hc_track WHERE tm = '" . date('Y-m-d') . "' AND tracking_page_name = 'homecubic_home'";
                    ...
                    <div>                                    
                        ...
                        <div class="widget-subtitle">D&iacute;a de hoy</div>
                        <div class="widget-int"><?php
                            $visit_select = "SELECT count(tracking_page_name) FROM hc_track WHERE tm = '" . date('Y-m-d') . "' AND tracking_page_name = 'homecubic_home' AND ref = 'DIRECTO'";
                            $visit_result = $link->query($visit_select) or die($link->error);
                            $visit_row = $visit_result->fetch_array(MYSQLI_BOTH);
                            echo $visit_row[0];
                            ?></div>
            ...
            <div class="widget widget-default widget-item-icon" onclick="location.href = 'pages-messages.html';">
                ...
                <div class="widget-data">
                    <div class="widget-int num-count"><?php
                        $select = "SELECT COUNT(idContact) FROM hc_messages WHERE statusContact = 'New'";
