...
if (isset($_POST['editmenu'])) {
    if (isset($_POST['1_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['1_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '1'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['2_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['2_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '2'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['3_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['3_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '3'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['4_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['4_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '4'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['5_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['5_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '5'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['6_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['6_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '6'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['7_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['7_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '7'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['8_check'])) {
        $val_select = "UPDATE hc_menu SET estadoMenu ='1' WHERE idMenu = '" . $_POST['8_check'] . "'";
        $val_result = $link->query($val_select) or die($link->error);
    } else {
        $val_select = "UPDATE hc_menu SET estadoMenu ='0' WHERE idMenu = '8'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['1_newname']) && $_POST['1_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['1_newname'] . "' WHERE idMenu = '1'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['2_newname']) && $_POST['2_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['2_newname'] . "' WHERE idMenu = '2'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['3_newname']) && $_POST['3_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['3_newname'] . "' WHERE idMenu = '3'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['4_newname']) && $_POST['4_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['4_newname'] . "' WHERE idMenu = '4'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['5_newname']) && $_POST['5_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['5_newname'] . "' WHERE idMenu = '5'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['6_newname']) && $_POST['6_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['6_newname'] . "' WHERE idMenu = '6'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['7_newname']) && $_POST['7_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['7_newname'] . "' WHERE idMenu = '7'";
        $val_result = $link->query($val_select) or die($link->error);
    }

    if (isset($_POST['8_newname']) && $_POST['8_newname'] != '') {
        $val_select = "UPDATE hc_menu SET nombreMenu ='" . $_POST['8_newname'] . "' WHERE idMenu = '8'";
        $val_result = $link->query($val_select) or die($link->error);
    }
...
if (isset($_POST['submitnewlogo'])) {
    ...
    if ($imageFileType != "png") {
        ...
        $target_file = $target_dir . "redes.png";
    }
...
//    var_dump($_FILES);
//    var_dump($_POST);die;
    $text_select = "UPDATE hc_homeslider SET linea1 ='".$_POST['uptext']."', linea2 ='".$_POST['centertext']."', linea3 ='".$_POST['bottomtext']."'  WHERE idSlide = '2'";
    $text_result = $link->query($text_select) or die($link->error);
    $target_dir = "../../../../assets/img/slider/";
...
//    var_dump($_POST);
//    die;
    $text_select = "UPDATE hc_homeslider SET linea1 ='".$_POST['uptext']."', linea2 ='".$_POST['centertext']."', linea3 ='".$_POST['bottomtext']."'  WHERE idSlide = '3'";
    $text_result = $link->query($text_select) or die($link->error);
    $target_dir = "../../../../assets/img/slider/";
