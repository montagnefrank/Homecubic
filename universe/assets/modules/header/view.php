...
<div class="page-content-wrap">   
        ...
        <div class="col-md-6">
            <div class="col-md-12">
                <div class="panel panel-default" id="quitarpanel">
                    <div class="panel-body">
                        <h3><span class="fa fa-picture-o"></span> Cambiar Logo <span data-toggle="tooltip" 
                              data-placement="top" 
                              title="600 x 600" 
            ...
            <div class="col-md-6">
                <div class="panel panel-default">                            
                    <div class="panel-body panel-body-image">
                        <img src="../assets/img/redes.png" alt="Logo"/>
                        <a href="#" class="panel-body-inform">
                            <span class="fa fa-heart-o"></span>
                        </a>
                    </div>
                    <div class="panel-footer text-muted">
                        <span class="fa fa-comment-o"></span> Logo del Website
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">                            
            <div class="panel-body panel-body-image">
                <img src="../assets/img/slider/slide1.jpg" alt="Slide1"/>
                <a href="#" class="panel-body-inform">
                    <span class="fa fa-edit"></span>
                </a>
            </div>
            <div class="panel-body">
                <h3>Slide 1 &mdash; Editar la primera diapositiva <span data-toggle="tooltip" 
                              data-placement="top" 
                              title="1920 x 1080" 
                              class="pull-right fa fa-exclamation-circle"></span></h3>
                <p>Texto Superior:</p>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">                            
            ...
            <div class="panel-body">
                <h3>Slide 2 &mdash; Editar la segunda diapositiva <span data-toggle="tooltip" 
                              data-placement="top" 
                              title="1920 x 1080" 
                              class="pull-right fa fa-exclamation-circle"></span></h3>
                <p>Texto Superior:</p>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">                            
            <div class="panel-body panel-body-image">
                <img src="../assets/img/slider/slide3.jpg" alt="Slide3"/>
                <a href="#" class="panel-body-inform">
                    <span class="fa fa-edit"></span>
                </a>
            </div>
            <div class="panel-body">
                <form id="slide3form" action="<?php echo "assets/modules/" . $panel . "/control.php"; ?>" method="post" enctype="multipart/form-data">
                    <h3>Slide 3 &mdash; Editar la tercera diapositiva <span data-toggle="tooltip" 
                              data-placement="top" 
                              title="1920 x 1080" 
                              class="pull-right fa fa-exclamation-circle"></span></h3>
                    <p>Texto Superior:</p>
