...
if (isset($_POST['addnewBlog'])) {
    ...
    $val_select = "INSERT INTO hc_blog(titleBlog,subtitleBlog,dateBlog,headerimgBlog,postimgBlog,htmlBlog,categoryBlog,authorBlog,statusBlog) "
            . "VALUES ('" . $_POST['titleBlog'] . "','" . $_POST['subtitleBlog'] . "','" . $meses[$mes] . date(" d, Y") . "','" . $headerImage . "','" . $postImage . "','" . addslashes($_POST['entryBlog']) . "','" . $_POST['catBlog'] . "','" . $_SESSION["username"] . "','1')";
...
if (isset($_POST['editblogtitles'])) {
    ...
    $select = "UPDATE hc_blog SET subtitleBlog ='" . $_POST['subtitleBlog'] . "', titleBlog ='" . $_POST['titleBlog'] . "', categoryBlog ='" . $_POST['categoryBlog'] . "' WHERE idBlog ='" . $_POST['idBlog'] . "'";
