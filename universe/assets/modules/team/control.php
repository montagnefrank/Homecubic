...
if (isset($_POST['edittitles'])) {
    ...
    $val_select = "UPDATE hc_misc SET teamTitle ='" . $_POST['teamTitle'] . "', teamSubtitle ='" . $_POST['teamSubtitle'] . "' WHERE idSite = '1'";
...
if (isset($_POST['editmember'])) {
    ...
    $val_select = "UPDATE hc_team SET photoTeam = '" . $filename . "', nameTeam = '" . $_POST['nameTeam'] . "', jobTeam = '" . $_POST['jobTeam'] . "', profileTeam = '" . $_POST['profileTeam'] . "', fbTeam = '" . $_POST['fbTeam'] . "', igTeam = '" . $_POST['igTeam'] . "', twTeam = '" . $_POST['twTeam'] . "', statusTeam = '" . $_POST['statusTeam'] . "' WHERE idTeam  = '" . $_POST['idTeam'] . "'";
    $val_result = $link->query($val_select) or die($link->error);
...
if (isset($_POST['deletemember'])) {
    $val_select = "DELETE FROM hc_team WHERE idTeam = '" . $_POST['deleteid'] . "'";
    $val_result = $link->query($val_select) or die($link->error);
...
if (isset($_POST['newmember'])) {
    ...
    $val_select = "INSERT INTO hc_team(photoTeam,nameTeam,jobTeam,profileTeam,fbTeam,igTeam,twTeam,statusTeam) VALUES ('" . $filename . "','" . $_POST['nameTeam'] . "','" . $_POST['jobTeam'] . "','" . $_POST['profileTeam'] . "','" . $_POST['fbTeam'] . "','" . $_POST['igTeam'] . "','" . $_POST['twTeam'] . "','" . $_POST['statusTeam'] . "')";
    $val_result = $link->query($val_select) or die($link->error);
