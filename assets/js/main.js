/*--------------COMPRESSED FOR SECURITY REASONS----------------------

FULL VERSION OF THE FILE HAS DETAILED COMMENTS, IS DIVIDED INTO SECTIONS 
AND HAS A CLEAR STRUCTURE.

Project:    Elementy
Version:    1.5.5
Last change:    03.12.2017
Author: Abcgomel
...
function initPageSliders() {
    ...
    t(window).load(function() {
        t("body").imagesLoaded(function() {
            t(".loader-cont").fadeOut(), t("#loader-overflow").delay(200).fadeOut(700)
        })
