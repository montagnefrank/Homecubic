        ...
        <div class="rev_slider fullwidthabanner" data-version="5.1.4" id="modelslider" style="display:none;">
            <ul>
                ...
                <li data-index="rs-673" data-transition="zoomout" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/revo-slider/constr2-180x110.jpg" data-rotate="0" data-saveperformance="off" data-title="CONSTRUCT WORKS" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="assets/img/port/<?php echo $row[4]; ?>.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption rs-parallaxlevel-6" 
                        ...
                        <a class="tp-button1 button medium full-rounded thin  white ml-20" href="custom.php">MODELO CUSTOM</a>
                    </div>
...
?>
<div class="slidermodelpage owl-carousel mt-10" >
    <?php
    $selectimg = "SELECT * FROM hc_portsliderimg WHERE idPort ='" . $projectId . "' AND statusImage = '1'";
    $resultimg = $link->query($selectimg) or die($link->error);
    while ($rowimg = $resultimg->fetch_array(MYSQLI_BOTH)) {
        echo ' 
                <div class="item text-center">
                    <div class="post-prev-img">
                        <a href="#"  ><img src="assets/img/portslider/'.$rowimg[2].'.jpg" alt="img"></a>
                    </div>
                </div>
           ';
    }
